...
export function OrderTableFilters() {
  ...
  const { register, handleSubmit, control, formState: { isSubmitting }, reset } = useForm<OrderFiltersSchema>({
  ...
  function handleFilter({ orderId, customerName, status }: OrderFiltersSchema) {
    setSearchParams(state => {
      if (orderId) {
        state.set('orderId', orderId) // This is the line that appears in the URL
      } else {
